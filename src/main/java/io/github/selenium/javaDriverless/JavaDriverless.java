    ...
    public JavaDriverless(String nomeJanela, ChromeOptions options, boolean useProfileManagement) {
        ...
        try {
            if (useProfileManagement) {
                ...
                if (hadOldProcess) {
                    System.out.println("      ⚠️  Chrome antigo detectado e FECHADO!");
                } else {
                    System.out.println("      ✓  Nenhum processo antigo encontrado");
                }
                ...
                System.out.println("      ✓  Chrome iniciado (PID: " + pid + ")");
                
                // PASSO 4: Salvar PID
                this.profileManager.savePid(this.nomeJanela, pid);
                System.out.println("      ✓  PID salvo");
                ...
                long pid = this.chrome.getBrowserPid();
                System.out.println("      ✓  Chrome iniciado (PID: " + pid + ")");
                System.out.println("      ℹ️  Profile temporário (será deletado ao fechar)");
            }
            
            this.started = true;
            
            System.out.println("════════════════════════════════════════════════════");
            System.out.println("  ✅ JavaDriverless pronto para uso!");
            System.out.println("════════════════════════════════════════════════════\n");
            
        } catch (Exception e) {
            System.err.println("❌ Erro ao iniciar JavaDriverless: " + e.getMessage());
    ...
    public void quit() {
        try {
            ...
            if (useProfileManagement && profileManager != null) {
                ...
                System.out.println("      ✓  PID deletado");
            } else {
                System.out.println("[2/2] Sem limpeza necessária (gerenciamento desabilitado)");
            }
            
            System.out.println("════════════════════════════════════════════════════");
            System.out.println("  ✅ JavaDriverless encerrado com sucesso!");
            System.out.println("════════════════════════════════════════════════════\n");
            
        } catch (Exception e) {
            System.err.println("❌ Erro ao encerrar JavaDriverless: " + e.getMessage());
