 ...
 */
public class Alert {
    private static final Logger logger = JavaDriverlessLogger.getLogger(Alert.class);
    ...
    private static void warnNotDetected() {
        JavaDriverlessLogger.warn(logger,
            "Não foi possível detectar se o diálogo está sendo exibido; talvez seja necessário executar Page.enable antes");
    }
