...
public class JSRemoteObj {
    private static final Logger logger = JavaDriverlessLogger.getLogger(JSRemoteObj.class);
    ...
    public CompletableFuture<Object> execRaw(String script, Object[] args, boolean awaitRes,
        ...
        if (executionContextId != null && uniqueContext) {
            JavaDriverlessLogger.warn(logger, "executionContextId e uniqueContext=true; usando executionContextId");
        }
