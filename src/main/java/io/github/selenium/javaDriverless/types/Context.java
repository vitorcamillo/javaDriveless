...
public class Context implements AutoCloseable {
    ...
    // FIX BUG-10: Tipado como Chrome em vez de Object para evitar reflexão
     ...
     */
    public Context(Target baseTarget, Chrome driver, String contextId, 
    ...
    public BaseTarget getBaseTarget() {
        // FIX BUG-10: Acesso direto sem reflexão
        return driver.getBaseTarget().join();
    }
