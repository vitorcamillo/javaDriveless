...
public class SwitchTo {
    private static final Logger logger = JavaDriverlessLogger.getLogger(SwitchTo.class);
    ...
    public CompletableFuture<Target> frame(Object frameReference, boolean focus) {
        JavaDriverlessLogger.warn(logger,
            "driver.switchTo().frame() está deprecated. Use WebElement.contentDocument() em vez disso");
