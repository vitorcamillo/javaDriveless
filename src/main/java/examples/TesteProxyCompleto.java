...
public class TesteProxyCompleto {
    ...
    public static void main(String[] args) {
        ...
        try {
            // Configurar proxy
            String proxyString = "108.165.186.191:32051";
            ...
            // ============================================================
            // TESTE 2: Geolocalização completa
            // ============================================================
            System.out.println("┌─────────────────────────────────────────────────────────┐");
            ...
            System.out.println("   🗺️  País: " + geoJson.get("country_name").asText() + " (" + geoJson.get("country_code").asText() + ")");
            ...
            // ============================================================
            // TESTE 4: Verificação de IP alternativo
            // ============================================================
            System.out.println("┌─────────────────────────────────────────────────────────┐");
            ...
            // ============================================================
            // TESTE 6: Teste de Conexão via Proxy
            // ============================================================
            System.out.println("┌─────────────────────────────────────────────────────────┐");
            ...
            // ============================================================
            // TESTE 7: Verificação de DNS
            // ============================================================
            System.out.println("┌─────────────────────────────────────────────────────────┐");
            System.out.println("│ TESTE 7: Informações de Rede                           │");
            System.out.println("└─────────────────────────────────────────────────────────┘");
            
            Object connectionType = driver.executeScript("navigator.connection ? navigator.connection.effectiveType : 'N/A'");
            ...
            if (ipOk) passedTests++;
            if (geoIpOk) passedTests++;
            if (ipifyOk) passedTests++;
            // Headers, Navegador, Conexão e Rede sempre passam se chegou até aqui
            passedTests += 4;
